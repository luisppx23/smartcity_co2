...
<nav class="smart-navbar">
    <div class="smart-navbar-inner">
        ...
        <div class="smart-navbar-left">
            <img src="${pageContext.request.contextPath}/images/logo.jpeg" alt="Logo" class="smart-navbar-logo">
        ...
        <div class="smart-navbar-center">
            ...
            <a href="${pageContext.request.contextPath}/cidadao/registoVeiculo" class="smart-nav-link">Registar
                Veículo</a>
