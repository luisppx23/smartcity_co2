...
<div class="dashboard-container">
    ...
    <div class="dashboard-grid">
        <div class="dashboard-card dashboard-card-blue">
            ...
            <a href="${pageContext.request.contextPath}/cidadao/registoVeiculo" class="dashboard-button">Registar Veículo</a>
        </div>

        <div class="dashboard-card dashboard-card-beige">
            <h3>Simular Taxa</h3>
            <p>Consulte uma simulação da taxa associada.</p>
            <a href="${pageContext.request.contextPath}/cidadao/simularTaxa" class="dashboard-button">Simular Taxa</a>
        </div>
    </div>
